var messages = {
  ...
  labelFooter: {
    ...
    'hi': 'ग्रिड गार्डन के निर्माणकर्ता ',
  ...
  title: {
    ...
    'hi': 'Grid Garden - सीएसएस(CSS) ग्रिड सीखने के लिए एक खेल',
  ...
  warningUnsupported: {
    ...
    'hi': 'अरे नहीं, ग्रिड गार्डन इस ब्राउज़र पर काम नहीं करता है। इसके लिए<a href="http://caniuse.com/#feat=css-grid"> एक ब्राउज़र की आवश्यकता है जिसमें सीएसएस(CSS) ग्रिड चलता हो, जैसे कि</a>,<a href="https://www.mozilla.org/firefox/">फ़ायरफ़ॉक्स,</a>, <a href="https://www.google.com/chrome/">क्रोम</a>, या <a href="http://www.apple.com/safari/">सफारी</a>का नवीनतम संस्करण। सीएसएस(CSS) ग्रिड गार्डन खेलने के लिए उनमें से किसी एक का उपयोग करें। ',
  },
  flexboxFroggy: {
    ...
    'hi': 'सीएसएस फ्लेक्सबॉक्स सीखना चाहते हैं? खेलिए!',
  },
};
